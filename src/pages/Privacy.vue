            ...
            <section class="policy">
                ...
                <div class="policy__body">
                    ...
                    <ul>
                        ...
                        <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Hotels & Casinos Top.</li>
                        <li><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</li>
                        <li><strong>Country</strong> refers to: Australia, Canada, USA.</li>
                        ...
                        <li><strong>Website</strong> refers to Hotels & Casinos Top, accessible from <a href="https://hotelscasinotop.com/" target="_blank">https://hotelscasinotop.com/</a></li>
                    ...
                    <ul>
                        <li>By email: <a href="mailto:info@hotelscasinotop.com">info@hotelscasinotop.com</a></li>
                        <li>By visiting this page on our website: <a href="https://hotelscasinotop.com/" target="_blank">https://hotelscasinotop.com/</a></li>
                    </ul>
                </div>
            </section>
        </div>

            ...
            <section class="policy">
                ...
                <div class="policy__body">
                    ...
                    <ul>
                        ...
                        <li><strong>Website</strong> refers to Hotels & Casinos, accessible from <a href="https://casinolistingsca.com/" target="_blank">https://casinolistingsca.com/</a></li>
                    ...
                    <ul>
                        <li>By email: <a href="mailto:support@casinolistingsca.com">support@casinolistingsca.com</a></li>
                        <li>By visiting this page on our website: <a href="https://casinolistingsca.com/" target="_blank">https://casinolistingsca.com/</a></li>
                    </ul>
                </div>
            </section>
        </div>
